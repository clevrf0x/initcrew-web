...
function AboutUs() {
  ...
  const coreTeam = [
    ...
    {
      name: 'Mohammed Rizvan',
      imageUrl: '/images/team/core_members/rizvan.webp',
      handle: 'redwood_1337',
      linkedin: 'https://www.linkedin.com/in/mohammed-rizvan619',
      discord: '',
      twitter: '',
      instagram: 'https://www.instagram.com/riz_bashi',
      github: '',
      website: '',
    },
    {
      name: 'Sherin Saji Pallipad',
      imageUrl: '/images/team/core_members/sherin.webp',
      handle: 'stopper_back',
      linkedin: 'https://www.linkedin.com/in/sherinsaji',
      discord: 'https://discord.gg/ubvH9sP7',
      twitter: 'https://x.com/SherinSajiPPD',
      instagram: 'https://www.instagram.com/king_l_u_f_f_y',
      github: '',
      website: '',
    },
    // {
